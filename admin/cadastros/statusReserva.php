<?php
    ...
    $sql = "select idstatus from reserva where id = :id limit 1";
...
<div class="card shadow">
    ...
    <div class="card-body">
        <form name="formCadastro" method="post" action="salvar/statusReserva" data-parsley-validate="">
        <input type="hidden" readonly name="idreserva" id="idreserva" class="form-control" value="<?=$id?>">
